...
STARK_TOKEN=$(forge create --private-key $PRE_PRIVATE $ZAUN_DIR/lib/starknet-token/src/starkware/isd/solidity/StarkNetToken.sol:StarkNetToken | grep -i 'deployed to' | awk '{print $3}')
